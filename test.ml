(* test.ml - Unit tests for MicroGPT OCaml Port *)
open Printf

(* We'll use a simplified version of the Value module for testing, or include the original file *)
(* For simplicity, we'll re-include the necessary parts or wrap them *)
